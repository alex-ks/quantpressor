...
namespace Quantpressor
{
	namespace Compressors
	{
		...
		NativeCompressorWrapper::NativeCompressorWrapper( quantpressor::ICompressor *native )
		{
			nativeCompressor = native;
		}

		NativeCompressorWrapper::!NativeCompressorWrapper( )
		{
...
#pragma managed
		...
		ICompressionResult ^NativeCompressorWrapper::Compress( IGrid ^ grid,
		...
		IGrid ^ NativeCompressorWrapper::Decompress( IBinaryInputStream ^ stream )
		{
